    ...
    \def\simpleGrad{\noindent\hbox to 0pt{
            \vbox to 0pt{
                \noindent\begin{picture}(185,286.75)(5, 0)
                    ...
                    \put(64.5, 0){\makebox(70,40){\cyrillicfont \englishfont \fontsize{10pt}{0pt}\selectfont \itshape Разработка образовательной платформы }}
                    \put(64.5, 0){\makebox(70,30){\cyrillicfont \englishfont \fontsize{10pt}{0pt}\selectfont \itshape для изучения и обмена }}
                    \put(64.5, 0){\makebox(70,20){\cyrillicfont \englishfont \fontsize{10pt}{0pt}\selectfont \itshape ресурсами}}
